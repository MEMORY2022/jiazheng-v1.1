...
<body>
	<div class="welcome-wrap">
		<div class="container">
			<div class="wel-head">
				<div class="wel-logo">
					<img src="${pageContext.request.contextPath}/img/index/logo2.png" alt="" onClick="location.href=&#39;index.html&#39;"/>
				</div>
				<div class="switch-hire">
					<a href="${pageContext.request.contextPath}/html/employer_login.jsp" class="button button-3d button-action button-pill" style="padding:0 30px;">雇员端</a>
				</div>
				...
				<div class="login-content">
					...
					<div class="login-mian">
						...
						<div class="other-operation">
							...
							<a href="${pageContext.request.contextPath}/html/hire_register.jsp" class="quick-register">注册</a>
						</div>
					</div>
				</div>
			</div>
		...
		$(function () {
			$("#login").click(function () {
				...
				$.ajax({
					...
					type: "post",
					data: {"phone": phone, "password": password,"role":1},
