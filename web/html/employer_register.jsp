        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-mian">
                    <form id="registerform" action="${pageContext.request.contextPath}/employer/register" method="post">
                        <input hidden="hidden" type="text" value="0" name="role">
                        ...
                        <script type="text/javascript">
                            $("#get_btn").click(function () {
                                ...
                                if (phone.length==11) {
                                    $.ajax({
                                        url: "${pageContext.request.contextPath}/employer/sendSmsVercode",
                                        type: "post",
                        ...
                        $(function () {
                            ...
                            $("input[name='username']").blur(function () {
                                if ($(this).val() != null && $(this).val()) {
                                    $.ajax({
                                        url: "${pageContext.request.contextPath}/employer/register/namever",
                                        type: "post",
                                        data: {"username": $(this).val(), "role": "0"},
                                        success: function (data) {
                                            $("#registerinfo").attr("hidden", false);
                                ...
                                $("input[name='phone']").blur(function () {
                                    if ($(this).val().length == 11) {
                                        $.ajax({
                                            url: "${pageContext.request.contextPath}/employer/register/phonever",
                                            type: "post",
                                            data: {"phone": $(this).val(), "role": "0"},
                                            success: function (data) {
                                                $("#registerinfo").attr("hidden", false);
                                ...
                                $("input[name='usercard']").blur(function () {
                                    if ($(this).val().length == 18) {
                                        $.ajax({
                                            url: "${pageContext.request.contextPath}/employer/register/indentityVer",
                                            type: "post",
                                            data: {"usercard": $(this).val(), "role": "0"},
                                            success: function (data) {
                                                $("#registerinfo").attr("hidden", false);
